...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LayoutInflater imagen_acerca_de = LayoutInflater.from(MainActivity.this);
        final View vista = imagen_acerca_de.inflate(R.layout.acerca_de, null);
        ...
        btnAD.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alerta.setMessage("Kevin Ricardo Torres Muñoz"+"\nMelvin Antonio Angel López"+"\nITCA-FEPADE"+"\nModulo: Desarrollo de aplicaciones usando tecnologías emergentes")
                        .setCancelable(true)
        ...
        toolbar.setSubtitle("Estudiantes - Kevin Torres y Melvin Lopez");
